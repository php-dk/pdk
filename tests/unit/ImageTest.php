...
class ImageTest extends TestCase
{
    ...
    {
        $img = ToolsPhp\Types\objects\Image::createByArray(['path' => '/st1/fff.jpg']);
    }

    public function testCreateImg()
    {
        $img = new ToolsPhp\Types\objects\Image('http://static.realtor.im/st1/zgljamvj/1469011150578f54ce3a808.png');
        static::assertEquals('http://static.realtor.im/st1/zgljamvj/1469011150578f54ce3a808.png', (string)$img);
    }

    public function testSize()
    {
        $img = new ToolsPhp\Types\objects\Image('http://static.realtor.im/st1/1.png');
        $img->setSize([50,50]);
